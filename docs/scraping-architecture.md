...
| `post_composer` | `FEED_URL`, `PostComposer`, `SHARE_URL`, `author_keys()`, `authorship()`, `collapse_whitespace()`, `evidence_keys()`, `evidence_matches()`, `post_result()`, `scheduled_identifier()` | `page-owning` |
