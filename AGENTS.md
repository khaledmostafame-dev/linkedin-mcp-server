...
- Live status of both probes (signed-in English-UI post page, 2026-09-17 structural capture): the reactions control and the menu opener match it. The reactions dialog and the open menu's contents were not in that capture and remain to be confirmed live.
