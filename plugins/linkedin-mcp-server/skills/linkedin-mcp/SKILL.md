...
- `send_message`, `connect_with_person`, and the comment writes are write
  actions. Use them only when the user explicitly authorizes the
  exact recipient and action. Confirm the
